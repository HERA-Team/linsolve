...
class TestLinProductSolver:
    ...
    def test_degen_sol(self):
        ...
        # this fails for matrices where machine precision breaks degeneracies in system
        # of equations
        # self.assertRaises(np.linalg.LinAlgError, ls.solve_iteratively, mode='solve')
